<meta charset="utf-8">
  ...
  <!-- JQVMap -->
  <link rel="stylesheet" href="<?php echo asset('plugins/jqvmap/jqvmap.min.css'); ?>">
  <!-- Theme style -->
  ...
  <!-- summernote -->
  <link rel="stylesheet" href="<?php echo asset('plugins/summernote/summernote-bs4.css'); ?>">
  <!-- Google Font: Source Sans Pro -->
  <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700" rel="stylesheet">
  <!-- DataTables -->
  <link rel="stylesheet" href="<?php echo asset('plugins/datatables-bs4/css/dataTables.bootstrap4.css'); ?>"><?php /**PATH C:\xampp\htdocs\bocor\resources\views/admin/layouts/partials/head.blade.php ENDPATH**/ ?>